...
OpenHarmony AVCodec Kit需要提供丰富的音频编解码能力，其中 Opus 是一种广泛使用的低延迟、高质量音频编解码格式，适用于语音通话、音乐流媒体等场景。Opus 是业界成熟、经过广泛验证的开源音频编解码实现方案，引入该库可快速补齐 OpenHarmony 在 Opus 编解码方面的能力缺口。
